  ...
  const dropOffer = () => {
    return (
      <>
        ...
        <TextPopUp
          text={product?.status === "sold" ? "unavailable" : "Offer Sent"}
  ...
  return (
    <Grid.Column>
          ...
          <Grid.Row verticalAlign="middle">
            <Grid.Column>
              <Header icon>
                ...
                Buy Now <br />${product ? product.price : null}
              </Header>
              {product?.status === "sold" ? (
      ...
      <Container id="description">
        <p>
          <strong>Size: </strong>
          {product?.size}US - {product?.gender}
        </p>
        <p>
          <strong>Brand: </strong>
          {product?.brand}
        ...
        <p>
          <strong>Color: </strong>
          {product ? JSON.parse(product?.color).join(", ") : null}
        </p>
        <p>
