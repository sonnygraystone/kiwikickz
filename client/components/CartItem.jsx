  ...
  return (
    <>
      <Item>
        <Item.Image
          size="small"
          src={`data:image/jpg;base64,${cartItem.image1}`}
        />
        <Item.Image
          size="small"
          src={`data:image/jpg;base64,${cartItem.image2}`}
        />
        <Item.Image
          size="small"
          src={`data:image/jpg;base64,${cartItem.image3}`}
        />
        <Item.Image
          size="small"
          src={`data:image/jpg;base64,${cartItem.image4}`}
        />
      ...
      <Container>
        ...
        <Button
          onClick={() => {
            dispatch(RemovePriceFromCart(cartItem));
          }}
        >
          Remove
        </Button>
