...
const KEY =
  "pk_test_51KWbgYFReKnnv8idD5AniOTrgkHf4So0DdrlwUX8DmgsYcZ1MdH9ldHY6NX609yIEnBgqskqcmqnFvGLyl0C3KoF00dLM80Ga9";
  ...
  return (
    <div>
      <Container>
        ...
        {cart.length > 0 ? (
          cart.map((item, i) => <CartItem data={item} key={item.name + i} />)
        ) : (
