...
export function getAllProduct() {
  return request.get("/api/v1/product").then((res) => res.body);
}
...
export function getAllQuestion() {
  return request.get("/api/v1/question").then((res) => res.body);
}

export function getAllTransaction() {
  return request.get("/api/v1/transaction").then((res) => res.body);
}
